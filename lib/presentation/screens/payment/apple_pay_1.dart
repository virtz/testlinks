...
class ApplePay1 extends StatefulWidget {
  const ApplePay1({Key? key}) : super(key: key);

  @override
  _ApplePay1State createState() => _ApplePay1State();
}

class _ApplePay1State extends State<ApplePay1> {
  @override
