...
class SettingsNonPremium extends StatefulWidget {
  const SettingsNonPremium({ Key? key }) : super(key: key);

  @override
  _SettingsNonPremiumState createState() => _SettingsNonPremiumState();
}

class _SettingsNonPremiumState extends State<SettingsNonPremium> {
